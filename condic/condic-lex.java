...
switch_condic = "switch("("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)"){"(("case "([0-9]+|"'"[a-zA-Z]"'")":")+"{"(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)((("="(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)|([0-9])+)("+"|"-"|"*"|"\/")(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)|([0-9])+))|("++"|"--"))";"))+"break;}")+("default:{"(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)((("="(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)|([0-9])+)("+"|"-"|"*"|"\/")(("_"[a-zA-Z_0-9]+|[a-zA-Z]+[_0-9]*)|([0-9])+))|("++"|"--"))";"))+"}")?
